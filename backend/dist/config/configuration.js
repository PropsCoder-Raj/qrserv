...
exports.default = () => ({
    ...
    apiKeys: {
        ...
        subscriptionPlans: process.env.SUBSCRIPTION_PLANS_API_KEY || process.env.API_KEY || '',
    },
    jwt: {
    ...
    withdraw: {
        ...
        chargeGstPercentage: parseFloat(process.env.WITHDRAW_CHARGE_GST_PERCENTAGE || '18'),
    },
    mail: {
