    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                ...
                { name: subscription_history_schema_1.SubscriptionHistory.name, schema: subscription_history_schema_1.SubscriptionHistorySchema },
            ]),
        ],
        controllers: [subscriptions_controller_1.SubscriptionsController],
        providers: [subscriptions_service_1.SubscriptionsService, api_key_guard_1.ApiKeyGuard],
